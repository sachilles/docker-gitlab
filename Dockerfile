...
ENV GITLAB_VERSION=${VERSION} \
    ...
    GITLAB_PAGES_VERSION=19.0.0 \
    GITALY_SERVER_VERSION=19.0.0 \
    GITLAB_USER="git" \
    ...
    NODE_ENV=production \
    NO_SOURCEMAPS=true \
    # v18.11.0 : minimum = 16.5, maximum = 17.x (currently 17.9, is 170009)
    POSTGRESQL_SERVER_REQUIRED_VERSION_MINIMUM=160000 \
    POSTGRESQL_SERVER_REQUIRED_VERSION_MAXIMUM=170009
