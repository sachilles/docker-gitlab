...
ENV GITLAB_VERSION=${VERSION} \
    ...
    GITLAB_PAGES_VERSION=18.10.0 \
    GITALY_SERVER_VERSION=18.10.0 \
    GITLAB_USER="git" \
    ...
    NODE_ENV=production \
    NO_SOURCEMAPS=true \
    # v18.6.0 : minimum = 16.5, maximum = 17.x (currently 17.7, is 170700)
    POSTGRESQL_SERVER_REQUIRED_VERSION_MINIMUM=160005 \
    POSTGRESQL_SERVER_REQUIRED_VERSION_MAXIMUM=180200
