...
ENV GITLAB_VERSION=${VERSION} \
    RUBY_VERSION=3.0.4 \
    RUBY_SOURCE_SHA256SUM="70b47c207af04bce9acea262308fb42893d3e244f39a4abc586920a1c723722b" \
    GOLANG_VERSION=1.18.8 \
    GITLAB_SHELL_VERSION=14.13.0 \
    GITLAB_PAGES_VERSION=15.6.3 \
    GITALY_SERVER_VERSION=15.6.3 \
    GITLAB_USER="git" \
...
RUN set -ex && \
 ...
 && DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends -y \
      ...
      nginx openssh-server postgresql-client-14 postgresql-contrib-14 redis-tools \
